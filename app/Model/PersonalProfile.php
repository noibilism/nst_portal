...
/*	public $validate = array(
    ...
    public function all_b_members(){
        $result = $this->find('all', array('conditions'=>array('MONTH(PersonalProfile.dob)' => date('m'))));
        return $result;
    }
    ...
    public function zone_b_members($zone_id){
        $result = $this->find('all', array('conditions'=>array('PersonalProfile.zone_id'=>$zone_id, 'MONTH(PersonalProfile.dob)' => date('m'))));
        return $result;
    }
    ...
    public function branch_b_members($bch_id){
        $result = $this->find('all', array('conditions'=>array('PersonalProfile.branch_id'=>$bch_id, 'MONTH(PersonalProfile.dob)' => date('m'))));
        return $result;
    }
    ...
    public function getMemberDetails($access_code){
        $result = $this->find('first', array('conditions'=>array('PersonalProfile.access_code'=>$access_code)));
        return $result;
    }
