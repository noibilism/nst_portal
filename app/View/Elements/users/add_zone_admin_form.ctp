    ...
    <div class="widget-body">
        <div class="col-md-6">
            ...
            <div class="widget widget-4 row">
                ...
                <div class="separator"></div>
                <?php echo $this->Form->input('zone_id', array('class'=>'col-md-12 form-control','label'=>false,'placeholder'=>'Type your username here','options'=>$zones)); ?>
            </div>
            <div class="widget widget-4 row">
            ...
            <div class="widget widget-4 row">
                <?php echo $this->Form->submit(__('Add User'), array('class' => 'btn btn-large btn-primary'));?>
            </div>
        </div>
    </div>
    </div>